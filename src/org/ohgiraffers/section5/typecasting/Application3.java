...
public class Application3 {
    public static void main(String[] args) {
        /* 자동 형변환과 강제 형변환을 이용하여 서로 다른 자료형끼리 연산을 수행할수있다.*/

        int inum = 10;
        long lnum = 100;

        /*inum이 long타입으로 자동 형변환 된 뒤 연산이 일어나 연산 결과는 long이다. int에 담을 수 없다.*/
        //int isum = inum + lnum;

        /* 1. 두수의 연산 결과를 int 타입으로 변환*/
        int isum = (int) (inum + lnum);

        /* 2. long형 값을 int형으로 변환 시키고 연산*/
        int isum2 = inum + (int) lnum;

        /* 3. 결과 값을 long형 자료형으로 처리 (자동형변환)*/
