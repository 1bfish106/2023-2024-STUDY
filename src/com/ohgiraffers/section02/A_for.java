...
public class A_for {
    ...
    public void testForExample3(){
        ...
        System.out.println("1부터 " + random + "까지의 합계 : " + sum1);
    }
    public void testForExample4(){
        /*숫자 2개를 입력 받아 작은수에서 큰 수까지의 합계를 구하시오.
        * 단, 두숫자는 같은숫자가 아님*/
        Scanner sc = new Scanner(System.in);
    ...
    /*작은수에서 큰수까지의 합계를 구하는것이기 떄문에
    * first와 second중 어느것이 더 큰 숫 인지 확인하면 작은 수~큰수 까지의 합계를 구하는 로직으로 작성 가능하다.*/
        int min = 0;
        int max = 0;
        int sum = 0;
        ...
        System.out.println(min + "에서" + max + "까지의 합계 : " + max);
    }

    public void printSimpleGugudan(){
        /* 구구단은 곱하는 수가 1부터 시작하여 9까지 1씩 증가하여 곱하는 규칙을 가지고 있다.*/

        /* 2~9 사이의 수를 입력 받아 구구단을 출력하고, 해당 범위의 수를 입력하지않으면
