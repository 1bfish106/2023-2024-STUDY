...
public class Application2 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 50; i++) {
            ...
            System.out.println("hashcode : " + sb1.hashCode()); //동일 인스턴스임 = 같은 주소값
        }
         ...
         * 둘 다 원본에 영향을 미친다.
         * */
        System.out.println("delete() : " + sb2.delete(2, 5)); //jaracle 2~5번째 안에 있는 글자가 삭제됨
        System.out.println("deleteCharAt() : " + sb2.deleteCharAt(0)); //aracle 맨앞에있는 글자가 삭제됨
        System.out.println("sb2 : " + sb2); //aracle 위에값이 그대로 리턴됨
        /* insert() : 인자로 전달된 값을 문자열로 변환 후 지정한 인덱스 위치에 추가한다.
         * 원본에 영향을 미친다.
         * */
        System.out.println("insert() : " + sb2.insert(1, "vao")); //첫번째 문자뒤에 str을 넣음
        System.out.println("insert() : " + sb2.insert(0, "j")); //맨앞에
         ...
         * 원본에 영향을 미친다.
         * */
        System.out.println("reverse() :" + sb2.reverse()); //거꾸로 출력해주세요
        System.out.println("sb2 : " + sb2);
