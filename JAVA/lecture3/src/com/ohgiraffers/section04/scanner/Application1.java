...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*2. 자료형별 값 입력 받기*/
        /*2-1. 문자열 입력 받기 : nextLine()-입력받은 값을 문자열로 반환*/
     //   System.out.print("이름을 입력하세요 : ");
     //   String name = sc.nextLine();
     //   System.out.println("입력하신 이름은 " + name + "입니다.");

        /*2. 정수형 입력받기 : nextInt() - 입력받은 값을 int형으로 반환
        * 숫자가 아닌 값을 입력하면 java.util.InputMismatchException 이 발생한다. (런타임에러)
    ...
    //    System.out.println("입력하신 금액은 " + money + "원 입니다.");
        ...
        /*2-3. 실수형 값 입력받기 - nextFloat () : 입력받은 값을 float 형으로 반환한다.
        * 정수형으로 입력하면 실수로 변홯ㄴ 후 정상 동작 되나 숫자 형태가 아닌 값은 InputMismatchException 발생*/
    //    System.out.print("키를 입력하세요 : ");
    //    float height = sc.nextFloat();
    //    System.out.println("입력하신 키는 " + height + "cm입니다.");

        /*2-4 논리형 값 입력 받기 : nextBoolean() : 입력받은 값을 boolean형으로 반환한다.
        * true or false 외의 다른값은 오류가 발생한다. */
    ...
    //    System.out.println("입력하신 논리값은 " + isTrue + "입니다.");
        ...
        * java.lang.String의 chatAT(int index)를 사용한다.
        * index는 0부터 시작하는 숫자 체계이며 컴퓨터에서 주로 사용하는 방식이다.
        * 만약 존재하지않는 인덱스를 입력하게 되면 java.lang.StringIndexOutOfBoundsException이 발생한다.*/
